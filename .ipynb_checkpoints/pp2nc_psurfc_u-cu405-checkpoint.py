...
filename1='umnsaa_psurfc000' # also what to call the filename out, and make a new directory, also the folder name
filename2='umnsaa_psurfc012'
fileoutname='umnsaa_psurfc'
