...
filename1='umnsaa_pverc000' # also what to call the filename out, and make a new directory, also the folder name
filename2='umnsaa_pverc012'
fileoutname='umnsaa_pverc'
