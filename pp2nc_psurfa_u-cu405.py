...
filename1='umnsaa_psurfa000' # also what to call the filename out, and make a new directory, also the folder name
filename2='umnsaa_psurfa012'
fileoutname='umnsaa_psurfa'
