...
filename1='umnsaa_psurfb000' # also what to call the filename out, and make a new directory, also the folder name
filename2='umnsaa_psurfb012'
fileoutname='umnsaa_psurfb'
