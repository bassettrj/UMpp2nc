...
filename1='umnsaa_pverb000' # also what to call the filename out, and make a new directory, also the folder name
filename2='umnsaa_pverb012'
fileoutname='umnsaa_pverb'
