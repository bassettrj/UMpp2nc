...
filename1='umnsaa_pverd000' # also what to call the filename out, and make a new directory, also the folder name
filename2='umnsaa_pverd012'
fileoutname='umnsaa_pverd'
